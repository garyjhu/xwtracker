...
import { formatDifference, formatSeconds, getTitle } from "../../utils/tools";
import { IconCalendarTime, IconChevronLeft } from "@tabler/icons-react";
import { solveDataOptions, solveTimesOptions, statsOptions } from "../../utils/query-options";
import dayjs from "dayjs";
import { deleteSolveData } from "../../services/backend";
import { SolveDataSearchKey } from "../../utils/types";

export function SolveDataPage() {
